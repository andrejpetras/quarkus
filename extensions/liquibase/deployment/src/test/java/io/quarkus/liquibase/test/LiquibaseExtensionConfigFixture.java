...
public class LiquibaseExtensionConfigFixture {
    ...
    public void assertAllConfigurationSettings(LiquibaseConfig configuration, String dataSourceName) {
        ...
        assertEquals(configuration.currentDateTimeFunction.orElse(null), currentDateTimeFunction(dataSourceName));
    ...
    public String currentDateTimeFunction(String datasourceName) {
        return getStringValue("quarkus.liquibase.%s.current-date-time-function", datasourceName);
    }
    ...
    public boolean migrateAtStart(String datasourceName) {
        return getBooleanValue("quarkus.liquibase.migrate-at-start", datasourceName);
    }

    public boolean cleanAtStart(String datasourceName) {
        return getBooleanValue("quarkus.liquibase.clean-at-start", datasourceName);
    }
