...
public class Liquibase {
     ...
     * @throws LiquibaseException if the method fails.
     */
    void reportStatus(boolean verbose, Writer output) throws LiquibaseException {
     ...
     * @throws LiquibaseException if the method fails.
     */
    void reportStatus(boolean verbose, Contexts contexts, LabelExpression labels, Writer output) throws LiquibaseException {
     ...
     * @throws LiquibaseException if the method fails.
     */
    void reportUnexpectedChangeSets(boolean verbose, Writer output) throws LiquibaseException {
     ...
     * @throws LiquibaseException if the method fails.
     */
    void reportUnexpectedChangeSets(boolean verbose, Contexts contexts, LabelExpression labelExpression, Writer output)
            throws LiquibaseException {
