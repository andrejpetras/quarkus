...
class LiquibaseCreatorTest {
    ...
    @Test
    @DisplayName("currentDateTimeFunction default matches liquibase default")
    void testCurrentDateTimeFunctionDefault() {
        creator = new LiquibaseCreator(runtimeConfig, buildConfig);
        assertEquals(defaultConfig.currentDateTimeFunction, createdLiquibaseConfig().currentDateTimeFunction);
    }

    @Test
    @DisplayName("currentDateTimeFunction carried over from configuration")
    void testCurrentDateTimeFunctionOverridden() {
        runtimeConfig.currentDateTimeFunction = Optional.of("TEST()");
        creator = new LiquibaseCreator(runtimeConfig, buildConfig);
        assertEquals(runtimeConfig.currentDateTimeFunction, createdLiquibaseConfig().currentDateTimeFunction);
    }
    ...
    void testDefaultSchemaNameOverridden() {
        runtimeConfig.defaultSchemaName = Optional.of("SCHEMA1,SCHEMA2");
        creator = new LiquibaseCreator(runtimeConfig, buildConfig);
